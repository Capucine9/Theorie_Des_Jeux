...
JOUEURS = ["le joueur 1", "le_joueur_2", "le_joueur_3", "J4"]
STRATS =  [ ["S_1", "S_2"], ["S_1", "S_2", "S_3", "S_4", "S_5"], ["S_1", "S_2", "S_3", "S_4"] ]
...
le cas ou les joueurs autre que le joueur 1 jouent tous leurs premiere strategie (depuis leurs liste
de strategies). La colone suivante, seul le dernier joueur joue sa strategie suivante (strategie
suivante dans sa liste de strategies). Si le dernier joueur a joue toute ses strategies,
alors le joueur precedent joue sa prochaine strategie et le dernier joueur rejoue toute ses strategies.
